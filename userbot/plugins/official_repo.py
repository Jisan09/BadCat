...
@bot.on(admin_cmd(outgoing=True, pattern=r"official($| (deploy))"))
@borg.on(sudo_cmd(pattern="official($| (deploy))",allow_sudo = True))
async def upstream(event):
    "For .official command, check if the bot is up to date, update if specified"
    ...
    if conf == "" and force_update is False:
        ...
        await event.delete()
        return await event.respond('[`.official deploy`] to update.Check `.info official` for details')
